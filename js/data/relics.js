...
export const RELIC_INFO = {
  ...
  minion: {
    name: "그림자의 유물",
    description:
      "의식에 제물의 유물을 몰래 들여온 배신자. 갇히지 않으면, 유물함에 제물의 유물이 남아있는 한 매일 밤 시작 전에 그것을 다른 사람에게 몰래 심는다 — 게임 시작할 때 유물함에 미리 하나 들어있는 게 유일한 여분이라, 제물의 유물은 전체 게임을 통틀어 최대 2개까지만 존재한다. 처형해도 의식이 곧바로 끝나지는 않는다 — 그 순간 제물의 유물을 지닌 자가 있으면 저주가 그 사람에게 옮겨가 새로운 그림자가 된다.",
  },
  sacrifice: {
    name: "제물의 유물",
...
// 그림자의 유물(하수인)을 진짜로 처형했을 때: 엉뚱한 처형(즉시 패배)과는 확실히
// 구분되는 성공 연출. 다만 그 순간 제물의 유물을 지닌 자가 있었다면 저주가 그
// 사람에게 옮겨간다(engine.js의 resolveExecution 참고) — 그럴 땐 이어서
// MINION_CURSE_TRANSFER_LINE이 뜬다.
export const MINION_CAUGHT_LINE =
  "가면이 벗겨진다 — 정체를 숨기고 있던 진짜 배신자, 그림자의 유물이 처형되었다!";
export const MINION_CURSE_TRANSFER_LINE =
  "하지만 저주는 거기서 끝나지 않는다. 제물의 유물을 쥐고 있던 다른 누군가에게로, 그림자의 힘이 스며든다...";
